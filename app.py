...
# 환경 변수 설정
#os.environ["OPENAI_API_KEY"] = "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"
...
characters = {
    "스폰지밥": ["네모바지", "https://i.namu.wiki/i/G76U8E6ed16NvMpCT6PZl0CPfKSqabubtx9PbCF12cP_GQeHpQfk3Pf8v7RKLNdjg_7BbPUnglO351wT27AkL9Aj4xNeBr19XnGUx0xzjRcZs8i5qHHkOgoO485beYjOFPhznziUpZwAzlzV7pN0UA.webp"],
    "뚱이": ["뚱이", "https://i.namu.wiki/i/RkF5qEfiAQUwOE6DAlohzQBXjWaZtQGnWK2zagvVYUZcc_s1jxFlHUgJl90viDTY5GjJMyeMZjuRWfm_twtmI425rjPoc6dZURPKMuquX9PXZopTq93tyPP1B69cxESPL38yvOW8QexbiMNWx9K7zg.webp"]
}


# 사용자 아바타 이미지 URL
user_avatar_url = "https://i.namu.wiki/i/eHw3IHUjaptoTDv_YN80GD_BvoMhXb4VKojxE-VPGHkvBt5NXYsuDC_pajP0f-zZqS6lskgIduApoqncvNzV8vXaQJqLF2EjfpEMOb4Sbmj3wW0jH6YTzKL6TYiLYlfzWuWul2KEo0ESlceTmiAUYQ.webp"
assistant_avatar_url = "https://via.placeholder.com/50?text=User"
...
def generate_conversation(language, character, user_input):
    ...
    [스폰지밥]: [https://namu.wiki/w/%EB%84%A4%EB%AA%A8%EB%B0%94%EC%A7%80%20%EC%8A%A4%ED%8F%B0%EC%A7%80%EB%B0%A5?from=%EC%8A%A4%ED%8F%B0%EC%A7%80%EB%B0%A5].
    [뚱이]: [https://namu.wiki/w/%EB%9A%B1%EC%9D%B4], 말투는 반말로 해주세요.
